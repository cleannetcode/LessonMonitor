...
namespace Lesson1.ASP.NET
{
    public class Startup
    {
        ...
        {
            services.AddTransient<IValidator, ValidatorProperty>();
            services.AddScoped<IRepositoryDb, FakeRepositoryDb>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Lesson1.ASP.NET v1"));
            }
